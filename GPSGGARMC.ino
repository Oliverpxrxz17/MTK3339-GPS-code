...
SoftwareSerial mySerial(9, 8); //Initialize SoftwareSerial, and tell it you will be connecting through pins 2 and 3
...
NMEA2=GPS.lastNMEA();
  ...
  Serial.println(NMEA2);
    Serial.print("latitude:       "); Serial.print(GPS.latitude, 5); Serial.println(GPS.lat);
    Serial.print("longitude:      "); Serial.print(GPS.longitude, 5); Serial.println(GPS.lon);
